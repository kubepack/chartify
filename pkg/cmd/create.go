...
func NewCmdCreate() *cobra.Command {
	...
	cmd.Flags().StringSliceVar(&ko.Deployments, "deployments", ko.Deployments, "Specify names of deployments (deployments.namespace)")
	cmd.Flags().StringSliceVar(&ko.Jobs, "jobs", ko.Jobs, "Specify names of jobs")
	cmd.Flags().StringSliceVar(&ko.PersistentVolumes, "pvs", ko.PersistentVolumes, "Specify names of persistent volumes")
