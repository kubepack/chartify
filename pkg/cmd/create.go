...
func NewCmdCreate() *cobra.Command {
	...
	cmd.Flags().StringSliceVar(&ko.PersistentVolumes, "pvs", ko.PersistentVolumes, "Specify names of persistent volumes(pv.namespace) to include in chart")
	cmd.Flags().StringSliceVar(&ko.PersistentVolumeClaims, "pvcs", ko.PersistentVolumeClaims, "Specify names of persistent volume claims(pvc.namespace) to include in chart")
	cmd.Flags().StringSliceVar(&ko.Pods, "pods", ko.Pods, "Specify the names of pods(pod.namespace) to include in chart")
	cmd.Flags().StringSliceVar(&ko.ReplicaSets, "replicasets", ko.ReplicaSets, "Specify names of replica sets(rs.namespace) to include in chart")
